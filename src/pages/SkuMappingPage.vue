...
const selected = ref<MappingItem[]>([])
const page = ref(1)
...
const onSelectionChange = (rows: MappingItem[]) => {
  selected.value = rows
}
...
const removeRow = (row: MappingItem) => {
