...
const announcements: Announcement[] = [
  ...
  },
  {
    ...
    content: '尊敬的客户：您好！为助力赛盈平台用户降本增效，无忧出海，赛盈分销平台联合连连国际支付推出支付手续费五折活动，低至0.15%,在2025年9月15日-2025年12月15日期间，在收银台选择"连连国际支付"支付订单，即可享受五折支付手续费的优惠。',
    date: new Date('2025-09-15')
  },
  {
    id: 394,
    title: '关于赛盈分销平台变更网站域名的通知',
    content: '尊敬的客户：您好！为了提升平台业务服务能力，赛盈分��平台将于2025年7月30日19：00起正式由原域名www.saleyee.cn迁移到新域名www.saleyee.com。原域名（www.saleyee.cn）将作为企业官网，仅展示公司介绍、服务内容等信息。',
  ...
  },
  {
    ...
    content: '尊敬的分销商：你们好！赛盈美国区部分商品的原退货地址"703Bartley-ChesterRd, Flanders,NJ,07836"将停止使用，更新为下述退货地址，请及时下载最新的数据包查看商品的退货地址。',
  ...
  {
    id: 388,
    title: '关于赛盈分销平台短信验证码接收异常的说明',
    content: '尊敬的分销商：因平台短信运营商为了严格落实国家反诈工作部署及行业监管要求，进一步提升短信服务安全性，导致部分号段的手机号码无法正常接收短信验证码。',
