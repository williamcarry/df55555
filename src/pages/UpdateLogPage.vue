...
const rows = ref<Array<{ id:number; platformType:string; platformAccount:string; platformWarehouse:string; platformSku:string; updateQty:number; batchId:string; syncStatus:string; syncTime:string; failReason:string; realStock:number; uploadTime:string }>>([])
