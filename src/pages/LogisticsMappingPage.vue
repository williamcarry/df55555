  ...
  <div class="bg-white rounded-lg border border-slate-200 p-6">
    ...
    <div class="mt-3">
      <ul class="w-full clearfix">
        ...
        <li class="float-left w-[45%] mr-[5%] mt-[5px] mb-[5px] min-h-[34px]">
          <span class="inline-block w-[100px] text-right align-top leading-[34px] mr-[10px]">平台物流名称：</span>
...
interface RowItem {
  ...
  platformShipId: string
  platformShipName: string
  saleYeeShipId: string
  saleYeeShipName: string
  saleYeeCompany: string
  createdAt: string
}
...
const onSelectionChange = (rows: RowItem[]) => { selected.value = rows }
