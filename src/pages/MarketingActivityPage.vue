...
const activities: Activity[] = [
  ...
  },
  {
    ...
    content: '尊敬的赛盈分销商伙伴，您好！跨境旺季的号角即将吹响，为助您精准备货、抢占Q4全年销售峰值，平台重磅启动【Q4丰收季】 主题促销活动，现诚挚邀请您参与！活动时间：2025年10月1日-10月31日',
  ...
  },
  {
    id: 6,
    title: '限时折扣活动通知',
    content: '亲爱的分销商，本周特推限时折扣活动，部分热销商品享受高达30%的价格优惠，机会难得，欢迎参与！',
  ...
  },
  {
    id: 12,
    title: '会员等级升级福利',
    content: '感谢您的长期支持！您的账户等级已升级，享受更多专属福利和优惠政策。',
