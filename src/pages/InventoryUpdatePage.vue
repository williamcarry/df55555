...
<template>
  <div class="bg-white rounded-lg border border-slate-200 p-6">
    ...
    <div class="mt-3 flex flex-wrap items-center gap-2">
      ...
      <button class="bg-primary text-white rounded px-2 h-[30px] text-xs" type="button">批量更新</button>
...
const rows = ref<Array<{ id:number; selected:boolean; platformType:string; platformAccount:string; platformSku:string; saleYeeSku:string; realStock:number; updateStock:number; autoUpdate:boolean; rule:string; source:string; updatedAt:string }>>([])
