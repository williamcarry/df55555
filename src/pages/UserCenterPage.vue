        ...
        <div class="flex min-h-screen">
          ...
          <div class="flex-1 min-w-0 p-6">
            ...
            <div v-if="activeMenu === 'info'" class="bg-white rounded-lg border border-slate-200">
              ...
              <div class="p-6 border-b border-slate-200">
                <div class="flex items-start justify-between">
                  <div>
                    ...
                    <div class="text-sm text-slate-600 mt-2">会员等��：普通会员</div>
              ...
              <!-- 专属客户经理 -->
              <div class="p-6 border-b border-slate-200">
                <h3 class="font-semibold text-slate-900 mb-4">���属客户经理</h3>
              ...
              <div class="p-6 border-b border-slate-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div class="text-center">
                    <div class="text-slate-600 text-sm">持仓库存</div>
                  ...
                  <div class="text-center">
                    <div class="text-slate-600 text-sm">待件待���购</div>
                    <div class="text-primary font-semibold text-lg">0</div>
                  </div>
                  <div class="text-center">
                    <div class="text-slate-600 text-sm">待上传设计图</div>
                    <div class="text-primary font-semibold text-lg">0</div>
                  </div>
                  <div class="text-center">
