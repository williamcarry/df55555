...
const messages: Message[] = [
  ...
  },
  {
    id: 3,
    title: '平台规则更新说明',
    content: '为进一步规范平台秩序，提升用户体验，我们对平台的部分规则进行了更新，详情请查看平台帮助中心。',
    date: new Date('2025-10-13')
  },
  {
    id: 4,
    title: '安全提示：账号保护',
    content: '为保护���的账户安全，我们建议您定期修改密码，启用双因素认证，避免在公共网络上登录账户。',
  ...
  },
  {
    id: 9,
    title: '合规经营提醒',
    content: '为确保平台的健康发展，我们提醒所有分销商遵守相关法律法规，诚信经营，共同维护平台秩序。',
