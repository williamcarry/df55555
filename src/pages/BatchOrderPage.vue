...
const templateRecords: TemplateRecord[] = [
  {
    id: 1,
    uploadTime: new Date('2025-10-15 14:30:25'),
    name: '10月份订单',
    status: '已完成'
  },
  {
    id: 2,
    uploadTime: new Date('2025-10-14 09:15:42'),
    name: '9月份订单汇总',
    status: '已完成'
  },
  {
    id: 3,
    uploadTime: new Date('2025-10-10 16:45:18'),
    name: '秋季新品订单',
    status: '已完成'
  },
  {
    id: 4,
    uploadTime: new Date('2025-10-08 11:20:33'),
    name: '库存补货单',
    status: '处理中'
  },
  {
    id: 5,
    uploadTime: new Date('2025-10-05 13:45:12'),
    name: '客户退货处理',
    status: '失败'
  },
  {
    id: 6,
    uploadTime: new Date('2025-10-01 10:30:45'),
    name: '定制订单',
    status: '已完成'
  },
  {
    id: 7,
    uploadTime: new Date('2025-09-28 15:22:17'),
    name: '批发合作订单',
    status: '已完成'
  },
  {
    id: 8,
    uploadTime: new Date('2025-09-25 09:45:30'),
    name: '促销活动订单',
    status: '已完成'
  }
]
...
const downloadTemplate = () => {
  ...
  link.href = '#'
  link.download = 'batch-order-template.xlsx'
  link.click()
}
