...
const notifications: Notification[] = [
  ...
  },
  {
    ...
    content: '尊敬的分销商：您好！经过我们与物流合作伙伴的协商，US仓部分商品的发货时效将得到进一步优化。预计发货时间将缩短1-2个工作日，有助于提升您的客户满意度。',
    date: new Date('2025-10-08')
  },
  {
    id: 105,
    title: '新增商品分类 - 户外园艺系列',
    content: '尊敬的分销商：您好！平台新增户外园艺系列商品分类，包括花盆、园艺工具、户外装饰等多款产品。随着春季的到来，该系列商品将迎来销售旺季，欢迎提前选品备货。',
  ...
  },
  {
    id: 107,
    title: '热销商品推荐 - 秋季爆款清单',
    content: '尊敬的分销商：您好！平台根据近期销售数据，为您整理了秋季热销商品清单��这些商品在市场上表现优异，建议您重点关注并加大推广力度。详情请登录平台查看。',
    date: new Date('2025-09-28')
  },
  {
    id: 108,
    title: '关于部分商品���装升级的通知',
    content: '尊敬的分销商：您好！为提升客户体验，部分商品的包装将进行升级。新包装更加精美牢固，有助于降低运输过程中的破损率。升级后的商品将陆续发货，敬请关注。',
