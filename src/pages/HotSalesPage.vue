      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        <div class="bg-purple-600 text-white px-6 py-4 flex items-center gap-3">
          <img
            ...
            class="w-6 h-6"
          />
          <h2 class="text-xl font-bold">收藏排行榜</h2>
        </div>
...
const hotRankingsBase: RankingItem[] = [
  {
    spu: '48805228',
    title: '10层9格无纺布鞋柜 ��色',
...
const favoriteRankingsBase: RankingItem[] = [
  {
    spu: '84908498',
...
const downloadRankingsBase: RankingItem[] = [
  {
    spu: '75682614',
...
const publishRankingsBase: RankingItem[] = [
  {
    spu: '11900120',
...
const extendDemo = (arr: RankingItem[], times = 1): RankingItem[] => {
  const out: RankingItem[] = [...arr]
