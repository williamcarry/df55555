...
const selectedWarehouses = ref<string | null>(null)
...
const selectedProductWarehouses = ref<Record<number, string>>({})
...
function getNewTimeLabel(value: string): string {
  const option = newTimeOptions.find(o => o.value === value)
  return option?.label || ''
}

function getShipmentLabel(value: string): string {
  const option = shipmentOptions.find(o => o.value === value)
  return option?.label || ''
}

function getSaleModeLabel(value: string): string {
