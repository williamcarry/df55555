      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><a class="hover:text-primary" href="#">会员权益</a></li>
            <li><a class="hover:text-primary" href="#">赛盈学院</a></li>
            <li><a class="hover:text-primary" href="#">联系我们</a></li>
          </ul>
        </div>
        <div>
          <h3 class="text-white font-semibold mb-3">{{ t('footer.customer') }}</h3>
          <ul class="space-y-2 text-sm">
            <li><a class="hover:text-primary" href="#">帮助中心</a></li>
            <li><a class="hover:text-primary" href="#">售后条款</a></li>
            <li><a class="hover:text-primary" href="#">支付方式</a></li>
            <li><a class="hover:text-primary" href="#">物流方式</a></li>
            <li><a class="hover:text-primary" href="#">VAT政策解读</a></li>
            <li><a class="hover:text-primary" href="/feedback.html">体验反馈</a></li>
          </ul>
        </div>
        <div>
          <h3 class="text-white font-semibold mb-3">{{ t('footer.partners') }}</h3>
          <ul class="space-y-2 text-sm">
            <li><a class="hover:text-primary" href="#">跨境卖家入驻</a></li>
            <li><a class="hover:text-primary" href="#">供应商入驻</a></li>
            <li><a class="hover:text-primary" href="#">合作伙伴</a></li>
