<template>
  <div class="div">
    <p class="p">
      <a href="https://www.saleyee.com/" class="a">首页</a>
      <span class="span"></span>
      <a href="https://www.saleyee.com/home-and-furniture-2.html" class="a">家居和家具</a>
      <span class="span"></span>
      <a href="https://www.saleyee.com/storage-supplies-2.html" class="a">收纳用品</a>
      <span class="span"></span>
      <a href="https://www.saleyee.com/makeup-storage-2.html" class="a">妆饰收纳</a>
    </p>
  </div>
</template>
